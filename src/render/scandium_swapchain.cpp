...
namespace scandium {
	ScandiumSwapchain::ScandiumSwapchain(EngineDevice &deviceRef, VkExtent2D extent): device{deviceRef}, windowExtent{extent} {
		init();
	}
	...
	VkResult ScandiumSwapchain::submitCommandBuffers(const VkCommandBuffer *buffers, uint32_t *imageIndex){
	...
	void ScandiumSwapchain::createSwapChain() {
	...
	void ScandiumSwapchain::createImageViews(){
	...
	void ScandiumSwapchain::createRenderPass(){
	...
	void ScandiumSwapchain::createFramebuffers(){
	...
	void ScandiumSwapchain::createSyncObjects(){
	...
	VkSurfaceFormatKHR ScandiumSwapchain::chooseSwapSurfaceFormat(
	...
	VkPresentModeKHR ScandiumSwapchain::chooseSwapPresentMode(const std::vector<VkPresentModeKHR> &availablePresentModes){
	...
	VkExtent2D ScandiumSwapchain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities){
	...
	VkFormat ScandiumSwapchain::findDepthFormat() {
